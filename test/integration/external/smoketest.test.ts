 ...
 * as they build upon the state established by previous tests.
 */
describe('SudoVirtualCardsClient External Build Test Suite', () => {
  ...
  describe('Virtual cards', () => {
    ...
    it('virtual card creation successful', async () => {
      if (createdFundingSources.length === 0) {
        console.log('No funding sources available, cannot create virtual card')
        fail()
      }
